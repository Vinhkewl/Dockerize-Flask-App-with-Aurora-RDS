...
rds_data = boto3.client('rds-data', config=my_config, aws_access_key_id='TO-DO', aws_secret_access_key='TO-DO')

#Database Configuration Items
aurora_db_name = 'TO-DO' #os.environ['DB_NAME']
aurora_cluster_arn = 'TO-DO' #os.environ['CLUSTER_ARN']
aurora_secret_arn = 'TO-DO' #os.environ['SECRET_ARN']
